...
def signup(request):
    ...
    return render(request, 'App_Login/signup.html', context={'title': 'Sign Up MakeIt', 'form': form})
...
def edit_profile(request):
    ...
    return render(request, 'App_Login/profile.html', context={'form': form, 'title': 'Edit Profile MakeIT'})
